          ...
          <div className="space-y-8 text-center lg:text-left">
            ...
            <div className="relative lg:absolute lg:px-12 lg:bottom-0 z-20 lg:mb-[rem] flex flex-col lg:flex-row items-center lg:justify-between space-y-4 lg:space-y-0 lg:space-x-4">
              ...
              >
                ...
                <div className="w-27 h-14 bg-gradient-to-br rounded-lg overflow-hidden cursor-pointer hover:scale-105 transition-transform">
              ...
              <motion.div 
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, delay: 0.2 }} 
                className="hidden lg:block h-12 w-0.5 bg-cyan-400"
              />
              ...
              <motion.div 
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, delay: 0.2 }}
                className="flex flex-col justify-center lg:w-[12rem]"
              >
                <p className="text-white/80 mt-2 text-center lg:text-left">
